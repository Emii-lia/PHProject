...
$sql = "SELECT motif, SUM(montantSortie) as montantSortie FROM SORTIE WHERE ideglise = :id_eglise GROUP BY motif";
$id_eglise = $_GET['id'];
...
$graph->title->Set('Costs pie chart of the church group by motif');
