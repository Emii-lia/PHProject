            ...
            <div class="mt-2 px-7 py-2">
                <form action="./../backend/code.php" method="post" class="flex flex-col justify-around">
                    <div class="mb-8">
                        ...
                        <input type="date" class="mt-2 rounded-full shadow-md p-3 w-full" name="dateEntre" id="" placeholder="Enter the date of incoming">
                    </div>
                    <div class="mb-8">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="mt-2 rounded-full shadow-md p-3 w-full" name="montantEntre" id="" placeholder="Enter the value of the income">
                        <input type="radio" class="hidden" name="id" checked value="<?= $_GET['id'] ?>">
                    </div>
