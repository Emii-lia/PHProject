                ...
                <div class="flex flex-row justify-between items-center  py-14 w-[100%] pl-20 mb-16">
                    <div class="flex flex-row justify-between items-center w-full">
                        <form method="post" class="flex flex-row justify-start w-[90%]">
                            ...
                            <button type="submit" name="search_sortie" class="bg-[#4F758C] drop-shadow-md rounded-r-3xl flex flex-row justify-center items-center cursor-pointer"><img class="drop-shadow-md py-1 w-[80%] h-[80%] text-[#f0f2f0]" src="./assets/icons/search.svg" alt=""></button>
                        </form>
